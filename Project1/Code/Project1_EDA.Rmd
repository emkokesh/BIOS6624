...
removed_summary <- complete_flags %>%
  ...
  mutate(
    reason = case_when(
      ...
      have_y0 & have_y2 & y0_outcomes_complete & y2_outcomes_complete & y0_covars_complete & !y2_covars_complete ~ "Missing 1+ covariate at Year 2",
      have_y0 & have_y2 & y0_outcomes_complete & y2_outcomes_complete & y0_covars_complete & y2_covars_complete & !y2_adh_complete ~ "Missing adherence at Year 2",
      TRUE ~ "Other"
    )
  )
