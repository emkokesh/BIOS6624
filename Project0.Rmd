...
bias_model <- lmer(bias ~ 1 + (1 | SubjectID), data = df_q1)
summary(bias_model)

bias_model_sample <- lmer(bias ~ factor(Collection.Sample) + (1 | SubjectID), data = df_q1)
anova(bias_model, bias_model_sample)
