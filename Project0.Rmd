...
#cortisol
cort_model <- lmer(Cortisol_nmol ~ time_rise + time_decline + (1 | SubjectID), 
                   data = df_cort_clean)
summary(cort_model)

#DHEA model 
dhea_model <- lmer(DHEA_nmol ~ time_rise + time_decline + (1 | SubjectID), 
                   data = df_dhea_clean)
summary(dhea_model)
...
#plot 
ggplot(df_cort_clean, aes(x=MEMs_Min_Since_Wake, y=Cortisol_nmol))+
  geom_point()+
  labs(
...
ggplot(df_dhea_clean, aes(x=MEMs_Min_Since_Wake, y=DHEA_nmol))+
  geom_point()+
  labs(
